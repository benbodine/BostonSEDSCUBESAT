...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 24 Aug 2020 16:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 24 Aug 2020 16:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 24 Aug 2020 16:00:00.000000000
        Stop		 31 Aug 2020 16:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 24 Aug 2020 16:00:00.000000000
    ...
    BEGIN QuickReports
        ...
        BEGIN Report
            ...
            Style		 Access
            AGIViewer		 No
            Instance		 Place/Cambridge/Sensor/Sensor1
            BEGIN InstanceList
...
"24 Aug 2020 16:00:00.000000000" "31 Aug 2020 16:00:00.000000000"
                        END Intervals
            ...
            WindowRectLeft		 458
            WindowRectTop		 212
            WindowRectRight		 3636
            WindowRectBottom		 1227
        END Report
    END QuickReports
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 24 Aug 2020 16:00:00.000000000
                    Stop		 25 Aug 2020 16:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
        ...
        BEGIN Desc
            ...
            END ShortText
            BEGIN LongText
Calculate Access for an ISS obit
            END LongText
        END Desc
...
<SCOPE>
    <VAR name = "ClutterMap">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 24 Aug 2020 16:00:00.000000000
                EndTime		 31 Aug 2020 16:00:00.000000000
                CurrentTime		 25 Aug 2020 17:19:30.000000000
                Direction		 Forward
                UpdateDelta		 60
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Place/Cambridge
            Place/Cambridge		
            Place/Cambridge/Sensor/Sensor1		
        END Instance
        Instance Place/Cambridge/Sensor/Sensor1
            Place/Cambridge/Sensor/Sensor1		
        END Instance
